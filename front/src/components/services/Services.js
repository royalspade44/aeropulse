          ...
          <div className="sidebar-section">
            ...
            <div className="benefits-list">
              <div className="benefit-item">
                <img src={icons.checkCircle} alt="" className="inline-icon" />{" "}
              ...
              >
                ...
                <div className="service-card-content">
                  ...
                  <div className="service-details">
                    ...
                    <span className="service-detail">
                      <img
                        src={icons.memberList}
                        alt=""
                        className="inline-icon"
                      />{" "}
                      {service.technicians}{" "}
                      {service.technicians === 1 ? "technician" : "technicians"}
                    </span>
                  </div>
                  <div className="service-price">
                    <div>
                      {service.discount && (
                        <span className="original-price">
                          ₱{(service.price * 1.2).toLocaleString()}
                        </span>
                      )}
                    ...
                    <span className="warranty-chip">
                      <img src={icons.lock} alt="" className="inline-icon" />{" "}
