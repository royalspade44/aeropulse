...
const processingTasks = [
  { code: 'TK-110', technician: 'John Dela Cruz', customer: 'M. Santos', agingHours: 30, status: 'Processing' },
  { code: 'TK-111', technician: 'Anne Ramos', customer: 'R. Tan', agingHours: 18, status: 'In Progress' },
  { code: 'TK-112', technician: 'Mark Pineda', customer: 'L. Reyes', agingHours: 40, status: 'Processing' }
];
