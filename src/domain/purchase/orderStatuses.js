...
/** Payment lifecycle */
export const PAYMENT_PROCESSING_GATEWAY = 'processing_payment_gateway';
export const PAYMENT_PROCESSING_COD = 'processing_cod';
export const PAYMENT_PROCESSING_INSTALL = 'processing_payment_on_installation';
